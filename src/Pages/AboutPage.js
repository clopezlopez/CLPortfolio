    ...
    <div className="AboutPage">
      ...
      <div className="about-container">
        <div className="about-content">
          <h2>Who I am</h2>
          <p>I am a veteran with a background in Network Administration and a freelance web developer in Watertown, NY. In my journey of becoming a front-end developer, I've found problem-solving to be my niche, learning has become my hobby, and creating my passion.</p>
          <br />
          <h2>What I do</h2>
